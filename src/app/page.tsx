     ...
     <Hero  />
      ...
      <section 
           id="About" >
            ...
            <div className="bg-gray-200 shadow-lg rounded-lg overflow-hidden transition transform hover:scale-105 mx-11">
              ...
              />
             <h1 className="text-center text-[24px] font-extrabold py-6">About Books</h1>
             <p className="flex items-center justify-center py-11  container mx-auto px-11 text-[24px] ">
      ...
      <section id="Contact">
        <div className="bg-gradient-to-r from-purple-500 to-pink-500">
          <h3 className="text-center font-bold py-11 text-[24px]">Contact me</h3>
          <p className="text-center py-11 container mx-auto px-4 text-[24px]">Contact for me about Sadia with my email and some other websites content details..
